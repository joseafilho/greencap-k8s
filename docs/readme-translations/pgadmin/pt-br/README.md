...
Este documento explica como acessar o pgAdmin4 instalado no cluster Kubernetes via Helm e Gateway API (HTTPRoute).

## Endereço de acesso

O pgAdmin está exposto via HTTPRoute no endereço:
